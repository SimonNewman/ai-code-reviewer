  ...
  "inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        pink: "border-pink text-white bg-pink/80 hover:bg-pink",
        purple: "border-purple text-white bg-purple/80 hover:bg-purple",
        blue: "border-blue text-white bg-blue/80 hover:bg-blue",
      },
    },
    defaultVariants: {
      variant: "default",
